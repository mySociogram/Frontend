    ...
    <tbody className='tbody'>
        <tr>
            ...
            <td style={{display: 'flex', marginLeft: "40%"}}>
                <img src={`./img/${props.coinImg}`} style={{ marginRight: '2px', width:'25%'}}/>
                <div style={{display:'flex', flexDirection:'column'}}>
                    <small style={{ fontSize: '13px'}}>{props.name}</small>
                    <small style={{marginTop: '-5px', fontSize: '11px'}}>{props.initials}</small>
                </div>
            </td>
            <td>
            ...
            <td>
            <img src={`./img/${props.arrow}`} style={{width:'14%'}}/>
            </td>
        </tr>
